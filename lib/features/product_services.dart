...
class ProductRequest {
  ...
  Future<AccessoryMix> fetchAccessorySort(token, sortPrice,sortTypeCom,name
      ) async{
    ...
    final response = await http.get(
      Uri.parse(
          'https://computer-services-api.herokuapp.com/accessory/all-accessories-for-customer?sort=$sortPrice&limit=20&type=$sortTypeCom&name=$name'),
