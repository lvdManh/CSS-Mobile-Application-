      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Địa chỉ: ${booking.cusAddress?.street}, ${booking.cusAddress?.ward}, ${booking.cusAddress?.district}',
              style: const TextStyle(fontSize: 16),
            ),
            const SizedBox(
              height: 10.0,
            ...
            Text(
              'Thời gian hẹn: ${dt1.hour}:${dt1.minute}, $weekday ${dt1.day}/${dt1.month}/${dt1.year}',
              style: const TextStyle(fontSize: 16),
            ),
            const SizedBox(
              height: 10.0,
