    ...
    for (var i in servicesListGet) {
      ...
      if (i.serviceAccessory!.hasAccessory == false) {
        ...
        for (var e in i.serviceAccessory!.serHasAcc!) {
          _orderDetails.datas![count].accessories!.add(AccessoriesQ(
              accessoryId: e.accessoryId!.id, amountAcc: e.amount));
        }
      }
      count++;
    }
                                                        ...
                                                        child: Card(
                                                          ...
                                                          child: ListTile(
                                                            ...
                                                            subtitle: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    'Đơn giá: ${convertMoney(servicesListGet[index].serviceAccessory?.serHasAcc?[i].accessoryId?.price)}đ'),
                                                                Row(
                                                                  mainAxisAlignment:
                                                                      MainAxisAlignment
                                                                          .spaceBetween,
                                                                  children: <
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        if (servicesListGet[index].serviceAccessory!.serHasAcc![i].amount! >
                                                                            1) {
                                                                          servicesListGet[index]
                                                                              .serviceAccessory!
                                                                              .serHasAcc![i]
                                                                              .amount = servicesListGet[index].serviceAccessory!.serHasAcc![i].amount! - 1;
                                                                        }
                                                                      },
                                                                    ),
                                                                    const SizedBox(
